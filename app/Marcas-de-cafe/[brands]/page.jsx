          ...
          <div className='grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto'>
              ...
              <div className='w-64 h-64 bg-white rounded-3xl shadow-xl p-8 transform transition-transform duration-300 hover:scale-105'>
                {infoBrand?.image_url
                  ...
                  <div className='relative w-full h-full'>
                    <Image
                      src={infoBrand?.image_url || '/placeholder.svg'}
                      alt={`Logo de ${typesCoffee || brand}`}
                      fill
                      priority
            ...
            <div className='space-y-6 text-center md:text-left'>
              ...
              <p className='text-lg text-[#5D4037] leading-relaxed'>
                Descubre todos los productos de esta marca seleccionados especialmente
                para ofrecerte la mejor experiencia cafetera.
              </p>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-bold text-[#3E2723] mb-4'>
              Productos de <span className='text-[#33691E]'>{typesCoffee || brand}</span>
            </h2>
