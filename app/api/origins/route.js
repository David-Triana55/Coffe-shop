import { createOrigin, getOrigins, updateOrigin } from '@/lib/data/origins'
...
export async function POST (req) {
  try {
    ...
    const data = await createOrigin(name, description, image_url)
    console.log(data)
...
export async function PUT (req) {
  try {
    ...
    updateOrigin(id, name, description, image_url)
