...
export async function createAuction (productId, startDate, endDate, initialPrice, brandId) {
  try {
    const auction = await sql`
      INSERT INTO auctions (product_id, start_date, end_date, initial_price, brand_id)
      VALUES (${productId}, ${startDate}, ${endDate}, ${initialPrice}, ${brandId})
      RETURNING id
    `
    return auction.rows
  } catch (e) {
