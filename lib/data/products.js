...
export async function createProduct (brandId, presentationId, categoryId, originId, accessoryId, name, imagesUrl, description, price, stock, originDetails, inAuction = false) {
  try {
